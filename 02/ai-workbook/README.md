...
- Problem program: [adversarial_saxpy_buggy.cu](./adversarial_saxpy_buggy.cu)
- Verification harness: [verify_saxpy.cu](./verify_saxpy.cu)
- Solution program(s):
  - [solutions/saxpy_solution.cu](./solutions/saxpy_solution.cu)
